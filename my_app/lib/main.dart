...
void main() async {
  ...
  await FirebaseAppCheck.instance.activate(
    webProvider: ReCaptchaV3Provider('6LempvMqAAAAACEX1cFlqcaGsYxEDHWryA8LF2UG'),
  ...
  await notificationHandler.initLocalNotifications(); // ✅ Ensure Local Notifications are initialized
  await notificationHandler.setupFirebaseMessaging(); // ✅ Set up Firebase Messaging

  // Handle notification tap when app is terminated
  RemoteMessage? initialMessage = await FirebaseMessaging.instance.getInitialMessage();
  if (initialMessage != null) {
    await notificationHandler.handleRemoteMessageTap(initialMessage);
  }
